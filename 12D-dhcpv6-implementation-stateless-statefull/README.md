## Lab 12D: DHCPv6 Implementation - Stateless vs. Stateful (12D.1 + 12D.2)
...
### 📂 12D.1: Stateless DHCPv6 (SLAAC + DNS)
...
### 📂 Lab 12D.2: Stateful DHCPv6 Implementation (Full Managed Mode)
